...
public class Join extends Operator {
    ...
    public String getJoinField1Name() {
        // some code goes here
        return this.child1.getTupleDesc().toString();
    }
    ...
    public String getJoinField2Name() {
        // some code goes here
        return this.child2.getTupleDesc().toString();
    }
    ...
    protected Tuple fetchNext() throws TransactionAbortedException, DbException {
        ...
        int fieldNum1 = td1.numFields();
        int fieldNum2 = td2.numFields();
            ...
            while (child2.hasNext()) {
                ...
                if (joinPredicate.filter(t1, t2)) {
                    ...
                    for (int j=0; j < fieldNum2; j++) {
                        tuple.setField(i+j, t2.getField(j));
                    }
                    return tuple;
                }
            }
